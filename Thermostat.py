...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        output = f"{"" + self.current_state.id + ", " + str(self.getFahrenheit()) + ", " + str(self.setPoint)}"       
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"{self.getFahrenheit():.1f}"   # format to 1 decimal place

                altCounter = altCounter + 1
            else:
                lcd_line_2 = f"{self.current_state.id + " " + str(self.setPoint)}"
